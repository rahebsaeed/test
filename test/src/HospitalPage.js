...
import MyComponent from './js/bootstrap-datepicker'
// import HeroSlider from './js/owl-carousel'
...
<div>
    ...
    <div className="color-plate"><a className="color-plate-icon"><i className="fa fa-cog fa-spin"></i></a>
        <h4>TCH</h4>
        <p>إليك بعض الألوان الرائعة المتوفرة في قالب TCH.</p>
        <span className="color1" onClick={() => changeColor('#1a76d1')}></span>
                <span className="color2" onClick={() => changeColor('#2196f3')}></span>
                <span className="color3" onClick={() => changeColor('#32b87d')}></span>
                <span className="color4" onClick={() => changeColor('#fe754a')}></span>
                <span className="color5" onClick={() => changeColor('#f82f56')}></span>
                <span className="color6" onClick={() => changeColor('#01b2b7')}></span>
                <span className="color7" onClick={() => changeColor('#6c5ce7')}></span>
                <span className="color8" onClick={() => changeColor('#85ba46')}></span>
                <span className="color9" onClick={() => changeColor('#273c75')}></span>
                <span className="color10" onClick={() => changeColor('#fd7272')}></span>
                <span className="color11" onClick={() => changeColor('#badc58')}></span>
                <span className="color12" onClick={() => changeColor('#44ce6f')}></span>
    </div>
...
{/* <HeroSlider/> */}
            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title">
                        <h2>نحن دائماً مستعدين لمساعدتك وعائلتك</h2><img src="/img/section-img.png" alt="#"/>
    ...
    <section className="why-choose section">
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title">
                        <h2>نحن نقدم خدمات مختلفة لتحسين صحتك</h2><img src="/img/section-img.png" alt="#"/>
    ...
    <section className="portfolio section">
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title">
                        <h2>نحافظ على قواعد النظافة داخل مستشفانا</h2><img src="/img/section-img.png" alt="#"/>
            ...
            <div className="row">
                <div className="col-lg-12 col-12">
                    <div className="owl-carousel portfolio-slider">
                        <div className="single-pf"><img src="/img/pf1.jpg" alt="#"/><a href="/portfolio-details/"
                                className="btn">عرض التفاصيل</a></div>
                        <div className="single-pf"><img src="/img/pf2.jpg" alt="#"/><a href="/portfolio-details/"
                                className="btn">عرض التفاصيل</a></div>
                        <div className="single-pf"><img src="/img/pf3.jpg" alt="#"/><a href="/portfolio-details/"
                                className="btn">عرض التفاصيل</a></div>
                        <div className="single-pf"><img src="/img/pf4.jpg" alt="#"/><a href="/portfolio-details/"
                                className="btn">عرض التفاصيل</a></div>
                        <div className="single-pf"><img src="/img/pf1.jpg" alt="#"/><a href="/portfolio-details/"
                                className="btn">عرض التفاصيل</a></div>
                        <div className="single-pf"><img src="/img/pf2.jpg" alt="#"/><a href="/portfolio-details/"
    ...
    <section className="services section">
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title">
                        <h2>نحن نقدم خدمات متنوعة لتحسين صحتك</h2><img src="/img/section-img.png" alt="#"/>
    ...
    <section className="section testimonials overlay" data-stellar-background-ratio="0.5" dir="ltr">
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title">
                        <h2>ما يقوله مرضانا عن علاجاتنا الطبية</h2><img src="/img/section-img2.png" alt="#"/>
                    </div>
                </div>
            </div>
            <div className="row">
    ...
    <section className="departments section">
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title">
                        <h2>نقدّم أقسامًا مختلفة لتشخيص أمراضك</h2><img src="/img/section-img.png" alt="#"/>
                    </div>
                </div>
            </div>
            <div className="row">
                        ...
                        <div className="tab-content" id="myTabContent">
                            <div className="tab-pane fade show active" id="t-tab1" role="tabpanel">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="department-right"><img src="/img/department.jpg" alt="#"/></div>
                                    </div>
                                </div>
                            </div>
                            <div className="tab-pane fade" id="t-tab2" role="tabpanel">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="department-right"><img src="/img/department1.avif" alt="#"/></div>
                                    </div>
                                </div>
                            </div>
                            <div className="tab-pane fade" id="t-tab3" role="tabpanel">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="department-right"><img src="/img/department2.webp" alt="#"/></div>
                                    </div>
                                </div>
                            </div>
                            <div className="tab-pane fade" id="t-tab4" role="tabpanel">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="department-right"><img src="/img/department3.webp" alt="#"/></div>
                                    </div>
                                </div>
                            </div>
                            <div className="tab-pane fade" id="t-tab5" role="tabpanel">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="department-right"><img src="/img/department4.webp" alt="#"/></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section id="team" className="team section overlay" data-stellar-background-ratio="0.5">
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title">
                        <h2>لدينا أطباء متخصصون لحل مشاكلكم الصحية</h2><img src="/img/section-img2.png" alt="#"/>
            ...
            <div className="row">
                <div className="col-lg-3 col-md-6 col-12" data-tilt>
                    <div className="single-team">
                        <div className="t-head"><img src="/img/team1.jpg" alt="#"/>
                ...
                <div className="col-lg-3 col-md-6 col-12 " data-tilt>
                    <div className="single-team">
                        <div className="t-head"><img src="/img/team2.jpg" alt="#"/>
                            <div className="t-icon"><a href="/appointement/" className="btn">احجز موعد</a></div>
                        </div>
                        <div className="t-bottom">
                ...
                <div className="col-lg-3 col-md-6 col-12 " data-tilt>
                    <div className="single-team">
                        <div className="t-head"><img src="/img/team3.jpg" alt="#"/>
                            <div className="t-icon"><a href="/appointement/" className="btn">احجز موعد</a></div>
                        </div>
                        <div className="t-bottom">
                            <p>جراحة العظام</p>
                ...
                <div className="col-lg-3 col-md-6 col-12" data-tilt>
                    <div className="single-team">
                        <div className="t-head"><img src="/img/team4.jpg" alt="#"/>
                            <div className="t-icon"><a href="/appointement/" className="btn">احجز موعد</a></div>
                        </div>
                        <div className="t-bottom">
    ...
    <section className="blog section" id="blog">
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title">
                        <h2>تابع آخر الأخبار الطبية لدينا.</h2><img src="/img/section-img.png" alt="#"/>
            ...
            <div className="row">
                <div className="col-lg-4 col-md-6 col-12">
                    <div className="single-news">
                        <div className="news-head"><img src="/img/blog1.jpg" alt="#"/></div>
                ...
                <div className="col-lg-4 col-md-6 col-12">
                    <div className="single-news">
                        <div className="news-head"><img src="/img/blog2.jpg" alt="#"/></div>
                        <div className="news-body">
                            <div className="news-content rightalign">
                ...
                <div className="col-lg-4 col-md-6 col-12">
                    <div className="single-news">
                        <div className="news-head"><img src="/img/blog3.jpg" alt="#"/></div>
                        <div className="news-body">
                            <div className="news-content rightalign">
            ...
            <div className="row">
                <div className="col-lg-12 col-md-12 col-12">
                    <div className="owl-carousel clients-slider">
                        <div className="single-clients"><img src="/img/client1.png" alt="#"/></div>
                        <div className="single-clients"><img src="/img/client2.png" alt="#"/></div>
                        <div className="single-clients"><img src="/img/client3.png" alt="#"/></div>
                        <div className="single-clients"><img src="/img/client4.png" alt="#"/></div>
                        <div className="single-clients"><img src="/img/client5.png" alt="#"/></div>
                        <div className="single-clients"><img src="/img/client1.png" alt="#"/></div>
                        <div className="single-clients"><img src="/img/client2.png" alt="#"/></div>
                        <div className="single-clients"><img src="/img/client3.png" alt="#"/></div>
                        <div className="single-clients"><img src="/img/client4.png" alt="#"/></div>
    ...
    <section className="appointment">
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title">
                        <h2>نحن دائماً جاهزون لمساعدتك. احجز موعدًا</h2><img src="/img/section-img.png" alt="#"/>
            ...
            <div className="row">
                ...
                <div className="col-lg-6 col-md-12 ">
                    <div className="appointment-image"><img src="/img/contact-img.png" alt="#"/></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <style>
                {`.whowe::before { right: 0; }
                .rrr { margin-left: 10px; }
                .Feautes .single-features::before { left: -72px; right: inherit; }
                .rightalign { text-align: right !important; }
                .services .single-service i { right: 0 !important; left: unset; }
                .rightalignserv { padding-right: 50px; text-align: right; }
                .departments .department-tab .tab-pane .department-left .list li i { margin-right: 0px; right: 0; margin-left: unset; }
                .departments .department-tab .tab-pane .department-left .list li { padding-right: 30px; padding-left: unset; }
                .departments .department-tab .tab-pane .department-left h3:before { right: 0 !important; left: unset; }
                @media only screen and (max-width: 767px) { .slicknav_nav li { padding-right: 35px; } }
                .slider .single-slider .btn { margin-right: unset; margin-left: 10px; }
                @media only screen and (max-width: 650px) { .slider .single-slider .button, .slider .single-slider p, .slider .single-slider h1 { margin-right: 45px; } }`}
            </style>
</div>
      );
}
